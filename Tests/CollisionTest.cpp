...
void CollisionTest::Initialize()
{
	...
	auto body = new Body(new CircleShape(200, glm::vec4{ 1.0f }), { 0, -207.5f }, { 0, 0 }, 1, Body::STATIC);
	m_world->AddBody(body);

	body = new Body(new CircleShape(200, glm::vec4{ 1.0f }), { -207.5f, 0 }, { 0, 0 }, 1, Body::STATIC);
	m_world->AddBody(body);
